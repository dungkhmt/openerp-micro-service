...
import {
  clearCache,
  clearErrors,
  fetchJoinedMeetingPlans,
  resetPagination,
  resetSort,
  setPagination,
  setSort,
  setSearch as setSearchAction,
} from "../../../store/joined-meetings";
...
const JoinedMeetings = () => {
  ...
  const {
    ...
    fetchLoading,
    errors,
  } = useSelector((state) => state.joinedMeetings);
  ...
  return (
    <>
      <Helmet>
        <title>Cuộc họp tham gia | Task management</title>
      </Helmet>
      <JoinedMeetingsListPage
        search={search}
        setSearch={setSearch}
