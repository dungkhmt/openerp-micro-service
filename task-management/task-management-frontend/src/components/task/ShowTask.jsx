      ...
      {task ? (
        <>
          ...
          <Box sx={boxComponentStyle}>
            ...
            <Box mb={3} sx={boxChildComponent}>
              <Box mb={3}>
                <Box display={"flex"} alignItems={"center"}>
                  <Avatar>
                    {task.createdByUserLoginId != null
                      ? task.createdByUserLoginId.charAt(0).toUpperCase()
                      : "N"}
                  </Avatar>
                  <Box px={2} display={"flex"} flexDirection={"column"}>
                    <Typography variant="body2" color={"secondary"}>
                      {task.createdByUserLoginId != null
                        ? task.createdByUserLoginId
                        : "Không có dữ liệu"}
                    </Typography>
                    <Box display={"flex"}>
                      <Typography
          ...
          <ChangeStatusModal
            ...
            partyIdDf={task.assignee.split("(")[0].trim()}
