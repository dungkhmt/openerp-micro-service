...
public enum ErrorCode {
    ...
    REGISTRATION_CLOSED("E0205", "Registration deadline has passed. You can no longer update sessions",
        HttpStatus.FORBIDDEN),
    NOT_A_MEMBER_OF_ORGANIZATION("E0206",
        "You are not a member of this organization, please contact the administrator to be added to the organization",
        HttpStatus.FORBIDDEN),
    NOT_A_MEMBER_OF_GROUP("E0207",
        "You are not a member of this group, please contact the administrator to be added to the group",
        HttpStatus.FORBIDDEN),
    ...
    ORGANIZATION_NOT_FOUND("E0310", "The organization not found", HttpStatus.NOT_FOUND),
    ORGANIZATION_USER_NOT_FOUND("E0311", "The organization member not found", HttpStatus.NOT_FOUND),
    GROUP_NOT_FOUND("E0312", "The group not found", HttpStatus.NOT_FOUND),
    GROUP_USER_NOT_FOUND("E0313", "The group member not found", HttpStatus.NOT_FOUND),
    LAST_ORGANIZATION_NOT_FOUND("E0314", "The last organization not found", HttpStatus.NOT_FOUND),
    INVALID_INVITATION_TOKEN("E0315", "The invitation token is invalid", HttpStatus.NOT_FOUND),
    ...
    INVITATION_ALREADY_HANDLED("E0500", "The invitation is already handled", HttpStatus.CONFLICT),
    ...
    CATEGORY_EXIST("E0505", "The category already exists. Please check the category list before adding a new one",
        HttpStatus.CONFLICT),
    ORGANIZATION_USER_INVITED("E0506", "User is already invited to the organization",
        HttpStatus.CONFLICT),
    ORGANIZATION_USER_DELETED("E0507", "User is already removed from the organization",
        HttpStatus.CONFLICT),
    GROUP_USER_ADDED("E0508", "User is already a member of the group",
        HttpStatus.CONFLICT),
    GROUP_USER_DELETED("E0509", "User is already removed from the group",
        HttpStatus.CONFLICT),
    ORGANIZATION_CODE_EXIST("E0510", "The organization code already exists", HttpStatus.CONFLICT),
    ORGANIZATION_USER_ADDED("E0511", "User is already a member of the organization",
        HttpStatus.CONFLICT),

    //410

    INVITATION_EXPIRED("E0600", "The invitation expired", HttpStatus.GONE),

    // 415

    UNSUPPORTED_MEDIA_TYPE("E0700", "Unsupported media type", HttpStatus.UNSUPPORTED_MEDIA_TYPE);
