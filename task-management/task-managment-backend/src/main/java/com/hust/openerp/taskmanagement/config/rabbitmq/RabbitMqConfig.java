package com.hust.openerp.taskmanagement.config.rabbitmq;
...
public class RabbitMqConfig {
    ...
    public MessageConverter jsonMessageConverter() {
        ...
        objectMapper.disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS); // optional, if using Java 8 date/time
                                                                              // types
    ...
    public Binding bindingEmailChannel(RabbitAdmin rabbitAdmin, HeadersExchange headersExchange, Queue queueEmail) {
