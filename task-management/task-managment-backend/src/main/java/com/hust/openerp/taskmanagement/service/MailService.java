...
public interface MailService {
     ...
     *
     * @param to      The mail address of recipients , must not be null or empty
     *                array.
     * @param cc      nullable array of valid RFC-5321 addresses.
     * @param bcc     nullable
     * @param subject nullable
     * @param replyTo may be null. When somebody hits Reply, the To field of their
     *                “reply” email will be set to the {@code replyTo} address you
     *                set in your account, rather than your From Address.
     * @throws MailParseException          in case of failure when parsing the
     *                                     message
     * @throws MailAuthenticationException in case of authentication failure
     * @throws MailSendException           in case of failure when sending the
     *                                     message
     */
     ...
     * All {@link MultipartFile} object with no file has been chosen in
     * multipart-form will be omitted.
     *
     * @param messageHelper
     * @param attachments
     * @throws MessagingException
     ...
     * address.
     *
     * @param to            The mail address of recipients , must not be null or
     *                      empty array.
     * @param cc            nullable array of valid RFC-5321 addresses.
     * @param bcc           nullable
     * @param subject       nullable
     * @param body          nullable
     * @param isHtml        whether to apply content type "text/html" for an HTML
     *                      mail, using default content type ("text/plain") else
     * @param replyTo       may be null. When somebody hits Reply, the To field of
     *                      their “reply” email will be set to the {@code replyTo}
     *                      address you set in your account, rather than your From
     *                      Address.
     * @param replyPersonal personal names that accompany mail addresses, may be
     *                      null
