export const deliverymanager = {
  id: "MENU_WMS_DELIVERY_MANAGER",
  icon: "DashboardIcon",
  text: "Quản lý giao hàng",
  child: [
    {
      id: "MENU_WMS_DELIVERY_MANAGER.DELIVERY_PERSON",
    ...
    {
      id: "MENU_WMS_DELIVERY_MANAGER.SHIPMENTS",
    ...
    {
      id: "MENU_WMS_DELIVERY_MANAGER.DELIVERY_TRIPS",
    ...
    {
      id: "MENU_WMS_DELIVERY_MANAGER.ITEMS",
