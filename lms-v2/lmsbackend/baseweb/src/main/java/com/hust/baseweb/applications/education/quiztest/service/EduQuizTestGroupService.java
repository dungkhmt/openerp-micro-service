...
public interface EduQuizTestGroupService {
    ...
    QuizGroupTestDetailModel getTestGroupQuestionDetailNotUsePermutationConfigHeavyReload(
        String userLoginId,
        String testID
    );
    ...
    QuizGroupTestDetailModel getQuestionsDetailWithUserExecutionChoideOfQuizGroupNotUsePermutationConfig(
        String userLoginId,
        String groupCode,
        String testID
    );
