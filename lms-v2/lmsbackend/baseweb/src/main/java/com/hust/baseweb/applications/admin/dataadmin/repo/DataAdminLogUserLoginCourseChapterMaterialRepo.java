...
public interface DataAdminLogUserLoginCourseChapterMaterialRepo
    extends JpaRepository<LogUserLoginCourseChapterMaterial, UUID> {
    ...
    @Query(value = "select * from log_user_login_course_chapter_material where user_login_id = ?3 offset ?1 limit ?2",
           nativeQuery = true)
