...
const Report = () => {
    ...
    useEffect(() => {
        if (provinceId !== '') {
            ...
            districtRequest.get_price_districts({
                provinceId,
                fromTime
            }).then(response => {
                if (response.code === 200) {
    ...
    return (
        ...
        >
            ...
            {Array.from(priceDistricts.entries()).map(([nameDistrict, values], index) => {
                                        ...
                                        (
                                            <LineChart
                                                    ...
                                                    series={[
                                                        ...
                                                        {name: 'apartment', label: 'Chung cư', color: 'green.6'},
