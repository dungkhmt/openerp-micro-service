package openerp.notification.config.security;
...
public class Jwt2AuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
    ...
    public Collection<GrantedAuthority> convert(Jwt jwt) {
        ...
        // We assume here you have "openerp-ui" client configured with "client roles" mapper in Keycloak
        final var publicClientAccess = (Map<String, Object>) resourceAccess
                .getOrDefault("openerp-ui", Collections.emptyMap());
