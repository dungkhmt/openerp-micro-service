                            ...
                            <StandardTable
                                ...
                                editable={
                                    isCreateForm && {
                                        onRowAdd: (newData) =>
                                            new Promise((resolve, reject) => {
                                                setTimeout(() => {
                                                    console.log("new data => ", newData);
                                                    if ( 
                                                        newQuantity == undefined || selectedProductId == null 
                                                        || newQuantity == null || newQuantity < 1
                                                    ) {
                                                        errorNoti("Vui lòng kiểm tra lại thông tin hàng hoá vừa nhập.");
                                                    } else {
                                                        const newRow = {
                                                            productId: selectedProductId,
                                                            productName: getProductNameFromProductId(
                                                                    selectedProductId,
                                                                    productList
                                                                ),
                                                            quantity: newQuantity,
                                                            warehouseId: selectedWarehouseId,
                                                            warehouseName: getWarehouseNameByWarehouseId(
                                                                    selectedWarehouseId,
                                                                    warehouseList
                                                                ),
                                                        };
                                        ...
                                        onRowDelete: (selectedProductNames) =>
                                            new Promise((resolve, reject) => {
                                                setTimeout(() => {
                                                    console.log("selected data => ", selectedProductNames);
                                                    const dataDelete =
                                                        productTableData.filter((product) =>
                                                            !selectedProductNames.includes(product["productName"])
                                                        );
                                                    setProductTableData([ ...dataDelete]);
                                                    resolve();
                                                });
