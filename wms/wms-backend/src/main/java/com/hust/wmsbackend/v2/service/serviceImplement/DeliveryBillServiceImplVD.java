...
import com.hust.wmsbackend.v2.service.DeliveryBillService;
...
@Slf4j
public class DeliveryBillServiceImplVD implements DeliveryBillService {
    ...
    @Override
    public DeliveryBillWithItems getDetailDeliveryBillById(String deliveryBillId) {
