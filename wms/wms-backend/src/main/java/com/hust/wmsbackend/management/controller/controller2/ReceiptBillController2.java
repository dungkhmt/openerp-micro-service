...
import com.hust.wmsbackend.management.service.service2.ReceiptBillService;
import com.hust.wmsbackend.management.service.service2.ReceiptService;
...
@RestController
@RequestMapping("/wmsv3/admin/receipt-bill")
@Validated
@Slf4j
@AllArgsConstructor(onConstructor_ = @Autowired)
public class ReceiptBillController2 {
