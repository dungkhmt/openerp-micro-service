...
alter table wms_delivery_bill
add constraint fk_delivery_bill_delivery_trip foreign key (delivery_trip_id) references wms_delivery_trip (delivery_trip_id) on delete cascade ;
