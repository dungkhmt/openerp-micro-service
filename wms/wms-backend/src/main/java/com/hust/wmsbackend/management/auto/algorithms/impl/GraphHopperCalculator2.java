...
import com.hust.wmsbackend.management.auto.impl.PathNotFoundException;
...
@Slf4j
@Component
public class GraphHopperCalculator2 implements DistanceCalculator2 {

    private final GraphHopper graphHopper;

    public GraphHopperCalculator2(@Value("${osm-file-path}") String osmFilePath) {
    ...
    public ResponsePath calculate(BigDecimal fromLat, BigDecimal fromLon, BigDecimal toLat, BigDecimal toLon) {
        log.info("Start calculate path 1");
