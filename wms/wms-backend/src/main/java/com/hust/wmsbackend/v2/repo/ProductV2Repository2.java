...
@Repository
public interface ProductV2Repository2 extends JpaRepository<Product, UUID> {
    ...
    @Query(value = "( select cast(wri.product_id as varchar) as productId , wp.\"name\" as productName , wri.quantity as quantity , " +
            "to_char(wri.created_stamp, 'dd-MM-yyyy')  as effectiveDateStr , 'IMPORT' as type " +
            ...
            "to_char(wiid.effective_date, 'dd-MM-yyyy')  as effectiveDateStr , 'EXPORT' as type " +
            ...
            "to_char(waoi.created_stamp, 'dd-MM-yyyy')  as effectiveDateStr , 'ASSIGNED' as type " +
            ...
            "to_char(wdti.created_stamp, 'dd-MM-yyyy')  as effectiveDateStr ,  " +
