...
@RestController
@RequestMapping("/wmsv3/delivery-manager")
@AllArgsConstructor(onConstructor_ = @Autowired)
@Validated
@Slf4j
public class ShipmentController2 {
    ...
    public ResponseEntity<ShipmentDTO> getDetailShipments(@PathVariable String shipmentId) {
    ...
    public ResponseEntity<DeliveryTripDTO> deleteDeliveryTripById(@PathVariable String tripId) {
        ...
        return response != null ? ResponseEntity.ok(response) : new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }
