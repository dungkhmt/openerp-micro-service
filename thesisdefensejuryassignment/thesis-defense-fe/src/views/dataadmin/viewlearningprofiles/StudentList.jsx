...
export default function StudentList(props) {
  ...
  function getStudentsOfCurrentPage() {
    ...
    request("GET", "/statistics/users", successHandler, errorHandlers, null, {
      params,
    });
  }

  function navigateToLeaningProfilesPageOfStudent(studentLoginId) {
    navigate(`/admin/data/view-learning-profiles/users/${studentLoginId}`);
  }
      ...
      <CardContent>
        <StandardTable
          ...
          onRowClick={(event, student) =>
            navigateToLeaningProfilesPageOfStudent(student.userLoginId)
          }
        />
      </CardContent>
    </Card>
