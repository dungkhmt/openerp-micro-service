...
import {
  copyTestCasesWithPublicMode,
  downloadAllTestCasesWithPublicMode,
...
export default function ListTestCase() {
  ...
  const [openModalPreviewTestcase, setOpenModalPreviewTestcase] =
    useState(false);
  const [openModalCopyTestcase, setOpenModalCopyTestcase] = useState(false);
  const [openModalDownloadTestcase, setOpenModalDownloadTestcase] =
    useState(false);
          ...
          onClick={() => {
            request(
              ...
              },
              {
                onError: (e) => {
                  errorNoti(
                    e?.response?.data?.message || "An error happened",
                    5000
                  );
                },
              }
    ...
    return (
      ...
      >
        <Typography variant="subtitle2">
          Do you want to copy all testcases or only public testcases?
        </Typography>
        <Box
          sx={{
            marginTop: "28px",
  ...
  const ModalDownload = () => {
    return (
      ...
      >
        <Typography variant="subtitle2">
          Do you want to download all testcases or only public testcases?
        </Typography>
        <Box
          sx={{
            marginTop: "28px",
