...
export default function StudentQuizDetail() {
  ...
  function handleDownloadExcel() {
    ...
    var sheet = utils.json_to_sheet(data);
    var wb = utils.book_new();
    sheet["!cols"] = wbcols;

    utils.book_append_sheet(wb, sheet, "answers");
    ...
    var sheetHeader = utils.json_to_sheet(dataHeader);
    //var wbh = XLSX.utils.book_new();
    sheetHeader["!cols"] = wbhcols;

    utils.book_append_sheet(wb, sheetHeader, "info");

    writeFile(wb, "quiz-test.xlsx");
  }
