...
export default function StudentAssignedToQuizGroups(props) {
  ...
  function navigateToGroupParticipantQuestionsPage({
    participantUserLoginId,
    quizTestGroupId,
  }) {
  ...
  async function exportExamQuestionsOfAllStudents() {
    ...
    let questionsOfStudents =
      studentQuestions ?? (await getQuestionsOfParticipants());
    ...
    generatePdfDocument(pdfExportedData, `${testId}.pdf`, () =>
    ...
    { title: "Họ tên", field: "fullName" },
    {
      ...
      render: (groupParticipant) => (
        <div style={{ display: "flex", columnGap: "10px" }}>
          <ViewGroupParticipantQuestionsButton
            groupParticipant={groupParticipant}
          />
          <ButtonExportSingleDataToPdf
            participantLoginId={groupParticipant.participantUserLoginId}
          />
        </div>
      ),
    },
