package thesisdefensejuryassignment.thesisdefenseserver.or_tools;
...
public class AssignTeacherAndThesisToDefenseJury {
    ...
    public AssignTeacherAndThesisToDefenseJury(List<Thesis> thesisList, List<Teacher> teacherList, int sessionNumber, int defenseJuryNumber) {
        this.thesisList = thesisList;
        this.teacherList = teacherList;
        this.defenseJuryNumber = defenseJuryNumber;
        this.thesisNumber = thesisList.size();
