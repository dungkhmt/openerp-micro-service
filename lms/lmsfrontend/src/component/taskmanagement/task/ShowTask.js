      ...
      {task ?
        <>
          ...
          <Box sx={boxComponentStyle}>
            ...
            <CommentSection listComment={listComment} loadComments={loadComments}
                            setLoadCommentsCallBack={(cmt) => setLoadComments(cmt)} projectId={task.project.id}/>
            <Box>
              <TextField
                variant='standard'
              ...
              <Box display={'flex'} justifyContent={"flex-end"} mt={2}>
                <Button variant="contained" color="primary" onClick={handleSubmit(onSubmitComment)}>Thêm bình
                  luận</Button>
              </Box>
            </Box>
          </Box>
          ...
          >
            ...
            }}>Thay đổi trạng thái</MenuItem>
            <MenuItem onClick={() => {
              history.push(`/taskmanagement/tasks/${task.id}/edit`)
            }}>Chỉnh sửa nhiệm vụ</MenuItem>
          </Menu>
          <ChangeStatusModal
            open={openModal}
