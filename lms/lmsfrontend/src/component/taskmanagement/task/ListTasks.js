...
import {LimitString} from '../ultis/helpers';
                        ...
                        <Box sx={boxComponentStyle}>
                            ...
                            >
                                ...
                                <Box display={'flex'} flexDirection={'row'} alignItems={'center'}>
                                    ...
                                    <Box>
                                        <Button variant="contained" color="success" onClick={() => setOpenAddNewMemberModal(true)}>Thêm thành viên mới</Button>
                                        <AddNewMemberModal
                                            open={openAddNewMemberModal}
                                            handleClose={() => setOpenAddNewMemberModal(false)}
                                            projectName={projectName}
                                            projectId={projectId}
                                            callBackIsLoadMember={() => setIsLoadMember(!isLoadMember)}
                                        />
                                    </Box>
                                </Box>
                            </Box>
