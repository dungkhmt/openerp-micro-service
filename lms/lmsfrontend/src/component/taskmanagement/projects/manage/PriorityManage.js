...
const PriorityManage = () => {
    ...
    return (
        <>
            ...
            <Box mb={3}>
                <Button variant="contained" onClick={() => setIsAddNewPriority(!isAddNewPriority)}>
            ...
            {isAddNewPriority &&
                <Box mb={3}>
                    ...
                    <Box>
                        <Button color="success" variant="contained" onClick={handleSubmitPriority}>
                            Submit
                        </Button>
                    </Box>
                </Box>
                            ...
                            {priorities.map((row) => (
                                ...
                                >
                                    ...
                                    <TableCell align="right">
                                        <Button onClick={() => handleDeletePriority(row.priorityId)}>Delete</Button>
                                    </TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
