...
const SkillManage = () => {
    ...
    return (
        <>
            ...
            <Box mb={3}>
                <Button variant="contained" onClick={() => setIsAddNewSkill(!isAddNewSkill)}>
            ...
            {isAddNewSkill &&
                <Box mb={3}>
                    ...
                    <Box>
                        <Button color="success" variant="contained" onClick={handleSubmitSkill}>
                            Submit
                        </Button>
                    </Box>
                </Box>
                            ...
                            {skills.map((row) => (
                                ...
                                >
                                    ...
                                    <TableCell align="right">
                                        <Button onClick={() => handleDeleteSkill(row.skillId)}>Delete</Button>
                                    </TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
