...
public class GccExecutor {
    ...
    private static final String BUILD_COMMAND_CPP_17 = "g++ -std=c++17 -Wall -DONLINE_JUDGE -O2 -lm -fmax-errors=5 -march=native -s -Wl,-z,stack-size=1000000 -o main main.cpp";
