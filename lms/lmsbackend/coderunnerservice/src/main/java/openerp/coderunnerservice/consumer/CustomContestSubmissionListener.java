...
import static openerp.coderunnerservice.config.rabbitmq.ProblemContestRoutingKey.JUDGE_CUSTOM_PROBLEM_DL;
import static openerp.coderunnerservice.config.rabbitmq.RabbitProgrammingContestConfig.DEAD_LETTER_EXCHANGE;
import static openerp.coderunnerservice.config.rabbitmq.RabbitProgrammingContestConfig.JUDGE_CUSTOM_PROBLEM_QUEUE;
