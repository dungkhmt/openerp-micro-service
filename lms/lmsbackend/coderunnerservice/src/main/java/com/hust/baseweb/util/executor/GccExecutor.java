...
public class GccExecutor {
    ...
    private static final String BUILD_COMMAND_CPP_11 = "g++ -std=c++11  -w -DONLINE_JUDGE -O2 -lm -fmax-errors=3 -march=native -s -Wl,-z,stack-size=268435456 -Werror=larger-than=268435456 -o main main.cpp";
