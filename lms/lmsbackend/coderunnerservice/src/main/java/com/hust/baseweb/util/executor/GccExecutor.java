...
public class GccExecutor {
    ...
    private static final String BUILD_COMMAND_CPP_17 = "g++ -std=c++17 -w -DONLINE_JUDGE -O2 -lm -fmax-errors=5 -march=native -s -Wl,-z,stack-size=268435456 -o main main.cpp";
