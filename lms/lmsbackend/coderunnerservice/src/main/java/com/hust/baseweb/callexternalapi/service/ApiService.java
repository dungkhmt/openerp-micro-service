package com.hust.baseweb.callexternalapi.service;
...
import com.hust.baseweb.callexternalapi.config.ClientCredential;
...
public class ApiService {
  ...
  public ResponseEntity<?> callLogContestSubmissionAPI(String url, ModelCreateContestSubmission model){
      if (clientCredential == null) {
          throw new RuntimeException("Client credential is unset");
      }
