...
const TripOrderItemsIn = () => {
    ...
    const fetchTripItems = () => {
        ...
        request(
            "get",
            `smdeli/trip-items/trip/${tripId}/delivering`,
            (res) => {
                ...
                <>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 3 }}>
                        <Button
                            variant="contained"
                            color="primary"
                            onClick={activeTab === 0 ? confirmOutTripItems : confirmInTripItems}
...
export default TripOrderItemsIn;