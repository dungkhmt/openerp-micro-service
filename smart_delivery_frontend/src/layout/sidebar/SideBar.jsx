...
import {setHubId} from "../../state/Action";
...
export default function SideBar(props) {
  ...
  useEffect(() => {
    ...
    // Lấy thông tin hubId từ token

    // Lưu hubId vào Redux store nếu có

      dispatch(setToken(keycloak.token)); // Hoặc dispatch setHubId(hubId)
  }, [keycloak.authenticated, keycloak.token, dispatch]);
