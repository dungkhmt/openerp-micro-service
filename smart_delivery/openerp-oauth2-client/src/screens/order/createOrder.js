...
import { request } from 'api'; // Giả sử bạn đã định nghĩa request trong file api.js
...
import {useRouteMatch} from "react-router-dom"; // Giả sử bạn đã định nghĩa notification
                                ...
                                <Grid container className={classes.detailWrap} spacing={2}>
                                    <Grid item xs={4}>
                                        <p style={{fontWeight: 'bold'}}>
                                            Tổng tiền thu hộ: {formData.totalprice}đ
                                        </p>
                                    </Grid>
                                    <Grid item xs={4}>
                                    ...
                                    <Grid item xs={4}>
                                        <p style={{fontWeight: 'bold'}}> Tiền trả người bán: {formData.totalprice - 20000}đ </p>
                                    </Grid>
                                </Grid>
