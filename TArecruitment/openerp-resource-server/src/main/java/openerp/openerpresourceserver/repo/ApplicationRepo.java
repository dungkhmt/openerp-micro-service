...
public interface ApplicationRepo extends JpaRepository<Application, Integer> {
    ...
    Page<Application> findByApplicationStatusAndSemester(String status, String semester, Pageable pageable);
    ...
    Page<Application> findApplicationsByClassSemester(String semester, Pageable pageable);
