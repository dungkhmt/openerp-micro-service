...
const ViewStudentCourseScreen = () => {
  ...
  const handleNavigateCreateCourse = () => {
    history.push(`/training_course/student/course/create`);
  };
  ...
  const handleNavigateCourseDetail = (course) => {
    history.push(`/training_course/student/course/${course.id}`);
  };
...
export default ViewStudentCourseScreen;