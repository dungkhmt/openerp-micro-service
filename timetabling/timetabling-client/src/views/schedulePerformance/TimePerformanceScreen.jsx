...
function TimePerformanceScreen() {
    ...
    const columns = [
        ...
        {
            title: "Hiệu suất sử dụng thời gian",
    ...
    return (
        <div>
            <MaterialTable
                title={"Danh sách mã lớp"}
                columns={columns}
                data={timePerformances}
                icons={tableIcons}
                components={{
                    Toolbar: (props) => (
                        <div style={{
...
export default TimePerformanceScreen;