...
function StudyWeekScreen() {

    const [studyWeeks, setStudyWeeks] = useState([]);

    useEffect(() => {
        request("get", "/study-week/get-all", (res) => {
            setStudyWeeks(res.data);
        }).then();
    }, [])
...
export default StudyWeekScreen;