...
function OpenBatchScreen() {
    ...
    const [openBatchs, setOpenBatchs] = useState([]);

    useEffect(() => {
        request("get", "/open-batch/get-all", (res) => {
            setOpenBatchs(res.data);
        }).then();
    }, [])
...
export default OpenBatchScreen;