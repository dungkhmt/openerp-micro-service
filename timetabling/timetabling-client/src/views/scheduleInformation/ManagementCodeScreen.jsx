...
function ManagementCodeScreen() {

    const [managementCodes, setManagementCodes] = useState([]);

    useEffect(() => {
        request("get", "/management-code/get-all", (res) => {
            setManagementCodes(res.data);
        }).then();
    }, [])

    const columns = [
        {
            title: "Management Code ID",
            field: "id",
        },
        {
            title: "Mã quản lý",
    ...
    const handleUpdateData = () => {
        ...
        request("get", "/management-code/update")
            .then(() => {
    ...
    return (
        <div>
            <MaterialTable
                title={"Danh sách mã quản lý"}
                columns={columns}
                data={managementCodes}
                icons={tableIcons}
                components={{
                    Toolbar: (props) => (
                        <div style={{
...
export default ManagementCodeScreen;