...
import openerp.openerpresourceserver.application.port.out.department_detail.usecase_data.StaffJobPositionHistory;
...
public class StaffJobPositionHistoryHandler extends ObservableUseCasePublisher
        implements CollectionUseCaseHandler<ExampleModel, StaffJobPositionHistory>
{
    @Override
    public void init() {
    ...
    @Override
    public Collection<ExampleModel> handle(StaffJobPositionHistory useCase) {
        return null;
    }
}
