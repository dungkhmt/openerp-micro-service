...
import { purchaseStaff } from "./LocalConstant";

function PurchaseStaffScreen({ screenAuthorization }) {
  const [params, setParams] = useState({
    page: 1,
    pageSize: 10,
    role: "SCM_PURCHASE_STAFF",
  });
...
const SCR_ID = "SCR_SCM_PURCHASE_STAFF";
export default withScreenSecurity(PurchaseStaffScreen, SCR_ID, true);
