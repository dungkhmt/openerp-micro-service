...
import { allUsers } from "./LocalConstant";

function AllUsersScreen({ screenAuthorization }) {
...
const SCR_ID = "SCR_SCM_ALL_USERS";
export default withScreenSecurity(AllUsersScreen, SCR_ID, true);
